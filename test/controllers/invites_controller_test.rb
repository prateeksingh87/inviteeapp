...
class InvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post invites_url, params: { invite: { address: @invite.address, referal_code: @invite.referal_code } }
    end
  ...
  test "should update invite" do
    patch invite_url(@invite), params: { invite: { address: @invite.address, referal_code: @invite.referal_code } }
