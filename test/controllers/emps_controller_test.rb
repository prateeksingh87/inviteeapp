...
class EmpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emp" do
    assert_difference('Emp.count') do
      post emps_url, params: { emp: { address: @emp.address, dob: @emp.dob, fname: @emp.fname, lname: @emp.lname } }
    end
  ...
  test "should update emp" do
    patch emp_url(@emp), params: { emp: { address: @emp.address, dob: @emp.dob, fname: @emp.fname, lname: @emp.lname } }
